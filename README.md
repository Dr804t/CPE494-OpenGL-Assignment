...
### Assignment 3 : Loading 3D model, camera following, object intersection
- **Character models and animations** provided by [Mixamo](https://www.mixamo.com/) by Adobe.
- Imported, modified, and rendered in OpenGL using custom animation and rendering code.
